...
public class BankingRepository {
    ...
    public void customerToAccountGetAccount(String accountNr) {
        String sql = "SELECT account_id FROM account WHERE account_number = :account_number";
        Map<String, Object> paramMap = new HashMap<>();
        paramMap.put("account_number", accountNr);
        Integer dbAccount_id = jdbcTemplate.queryForObject(sql, paramMap, Integer.class);
    }
    ...
    public void updateDeposit(String accountNr, BigDecimal dbBalance) {
    ...
    public void updateWithdrawal(String accountNr, BigDecimal dbBalance) {
        String sql = "UPDATE account SET balance = :balance WHERE account_number = :account_number";
        Map<String, Object> paramMap = new HashMap<>();
        paramMap.put("account_number", accountNr);
        paramMap.put("balance", dbBalance);
    ...
    public void updateMakeTransferFrom(String fromAccount, BigDecimal dbBalance) {
        String sql = "UPDATE account SET balance = :balance WHERE account_number = :account_number";
        Map<String, Object> paramMap = new HashMap<>();
    ...
    public void makeTransferTo(String toAccount, BigDecimal transfer) {
        String sql = "SELECT balance FROM account WHERE account_number = :account_number";
        Map<String, Object> paramMap = new HashMap<>();
    ...
    public void updateMakeTransferTo(String toAccount, BigDecimal dbBalance) {
        String sql = "UPDATE account SET balance = :balance WHERE account_number = :account_number";
        Map<String, Object> paramMap = new HashMap<>();
        paramMap.put("account_number", toAccount);
        paramMap.put("balance", dbBalance);
